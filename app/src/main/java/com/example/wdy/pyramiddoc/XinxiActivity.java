...
public class XinxiActivity extends AppCompatActivity {
        ...
        public void handleMessage(Message msg){
            switch (msg.what){
                case UPDATE_TEXT:
                    ...
                    zonghexinxit=info.getBed_num()+"床 "+info.getName()+" "+info.getSex()+"      ";
        ...
        public void handleMessage(Message msg){
            switch (msg.what){
                case UPDATE_TEXT2:
                    ...
                    if (Blood_p1!=null&&Blood_p1!=""&&Float.parseFloat(Blood_p1)>140)abnormalt+="收缩压"+Blood_p1+"!\n";
                    if (Blood_p2!=null&&Blood_p2!=""&&Float.parseFloat(Blood_p2)>90)abnormalt+="舒张压"+Blood_p2+"!\n";
    ...
    public void xq_click(View view) {
        JinriActivity.backflag=1;
        Intent intent=new Intent(XinxiActivity.this,JinriActivity.class);
        startActivity(intent);
    }

    public void back_click(View view) {
        Intent intent1=new Intent(XinxiActivity.this,MainActivity.class);
        Intent intent2=new Intent(XinxiActivity.this,AlloldActivity.class);
        if(backflag==0)startActivity(intent1);
        else startActivity(intent2);
    }

    public void xgjbxx_click(View view) {
        OldInfoXiugaiActivity.oldbackflag=1;
        OldInfoXiugaiActivity.oldersID=oldersID;
        Intent intent=new Intent(XinxiActivity.this,OldInfoXiugaiActivity.class);
        startActivity(intent);
    }

    public void xiadayizhu_click(View view) {
        YizhuActivity.zonghexinxit3=zonghexinxit;
        YizhuActivity.backflag=1;
        Intent intent=new Intent(XinxiActivity.this,YizhuActivity.class);
        startActivity(intent);
    }
    ...
    public void woyizhixiao_click(View view) {
        final Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if(MainActivity.conn!=null){
                    String sql="update basic_info set Flag_doc = 1 where ID ='"+oldersID+"'";
                    try{
                        java.sql.Statement statement=MainActivity.conn.createStatement();
        ...
        thread.start();
        Intent intent=new Intent(XinxiActivity.this,MainActivity.class);
        startActivity(intent);
    }
}
